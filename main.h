...
/**
 * struct fmt - struct op by Kalilu and Sandra
 * @fmt: The format
...
int write_number(int is_positive, int ind, char buffer[],
		int flags, int width, int precision, int size);
int write_num(int ind, char buff[], int flags, int width, int length,
		char padd, char extra_c);
int write_pointer(char buffer[], int ind, int length, int flags,
		int width, char padd, char extra_c, char padd_start);
